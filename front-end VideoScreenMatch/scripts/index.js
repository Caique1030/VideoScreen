...
// Função para buscar séries com base na pesquisa
function buscarSeries(query) {
    // Faça uma solicitação para o endpoint de busca
    getDados(`/series/search?q=${query}`)
        .then(data => {
...
searchButton.addEventListener('click', function () {
    ...
    if (query) {
        buscarSeries(query);
        // Esconder as outras seções quando uma busca é feita
