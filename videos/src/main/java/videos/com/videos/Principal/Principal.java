...
import videos.com.videos.Models.DadosTemporada;
...
import videos.com.videos.Service.ConsumoApi;
import videos.com.videos.Service.ConverteDados;
...
public class Principal {
    ...
    private void buscarSerieWeb() {
        ...
        if (dados == null || dados.titulo() == null || dados.titulo().trim().isEmpty()) {
            throw new InvalidSeriesDataException("Dados da série inválidos ou nulos");
        }
    ...
    private void buscarSeriePorTitulo() {
        ...
        if (serieBuscada.isPresent()){
            ...
            System.out.println("Serie nao encontrada ou nao gravada");
        }
    }
    ...
    private void buscarSeriesPorAtor() {
        ...
        List<Serie> serieEncontrada= repositorio.findByAtorContainingIgnoreCase(nomeAtor);
